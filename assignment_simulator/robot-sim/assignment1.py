...
##########################################
#    Functions for PD implementation     #
##########################################
def controller_PD(err, d_err):
...
def check_heading():
    ...
    Args: none;
    Returns: heading angle expressed in degrees;
    """
...
def turn_ang(alfa):
    """
    Function to make the robot turn for a specific angle with respect its current
    orientation.
    ...
    while 1:
        ...
        if(obst_coord[0] > DISTANCE_THRESHOLD):
            ...
            if(target_coord[0] != -1):
                ...
                drive(50, 0.1)
        # if an obstacle in the front is too close
        else:
